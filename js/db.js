  ...
  /* ---------------- LOCAL (demo) ---------------- */
    ...
    const seed = () => ({
      ...
      pilares: [
        ...
        { id: 2, sesion_id: SES, orden: 2, nombre: 'Financiero', icono: 'fa-coins', color: 'green', activo: true, enunciado: '¿Cómo aguantar hasta febrero con la venta a la mitad? ¿Qué gasto se puede pausar o volver variable sin romper la operación? ¿De dónde sale caja rápida sin endeudarse más? Datos: el equilibrio está cerca de $250M/mes y de mayo a agosto se vendieron $153M/mes. El personal pasó de pesar ~30% de la venta a ~50%; mercadeo es 0,3%. El margen de los impermeables sobre su costo directo es alto, entre 55 y 65%; el de las líneas institucionales es bajo. Hay deuda financiera y la caja alcanza para pocos meses.', subfrentes: ['Estructura de costos y gastos', 'Caja y financiación', 'Activos y capital de trabajo'] },
        { id: 3, sesion_id: SES, orden: 3, nombre: 'Estructura y Cultura', icono: 'fa-people-group', color: 'purple', activo: true, enunciado: '¿Cómo reorganizar 40 personas para vender más con la misma nómina? ¿Quién de planta podría estar hoy vendiendo, atendiendo clientes o despachando? ¿Cómo activar ideas y compromiso del equipo en plena crisis? Datos: estructura transversal, no piramidal: 27 operarios, coordinador de producción, líder de operaciones, dos de logística, líder general, líder de mercadeo, una auxiliar comercial, un vendedor, un practicante y una auxiliar administrativa. El brazo comercial son cuatro personas para unos 500 clientes y se debilitó este año.', subfrentes: ['Fuerza comercial', 'Roles y estructura', 'Cultura y capacidad de reinvención'] },
        { id: 5, sesion_id: SES, orden: 4, nombre: 'Operaciones', icono: 'fa-gears', color: 'teal', activo: true, enunciado: '¿Qué se puede fabricar o hacer con media planta parada? ¿Qué maquila, producto o servicio cabe en la capacidad y el material que ya tenemos? ¿Cómo bajar el costo por unidad sin sacrificar calidad? Datos: planta en Medellín con 27 operarios y materia prima de plástico reciclado. En abril despachó 56.000 unidades; de mayo a agosto, 28.000 al mes. Unas 25 referencias: impermeables, ponchos, gabanes, botas, delantales y batas. Logística de dos personas.', subfrentes: ["Capacidad y planta", "Compras y proveedores", "Logística y entregas", "Calidad y procesos"] },
