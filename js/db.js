  ...
  /* ---------------- LOCAL (demo) ---------------- */
    ...
    const seed = () => ({
      ...
      pilares: [
        ...
        { id: 5, sesion_id: SES, orden: 4, nombre: 'Operaciones', icono: 'fa-gears', color: 'teal', activo: true, enunciado: 'Planta, compras, logística y capacidad instalada. Con la demanda a la mitad, ¿cómo usar la maquinaria, el equipo y los proveedores para bajar costos, fabricar otras cosas o servir a nuevos clientes?', subfrentes: ["Capacidad y planta", "Compras y proveedores", "Logística y entregas", "Calidad y procesos"] },
        { id: 4, sesion_id: SES, orden: 5, nombre: 'Otros', icono: 'fa-lightbulb', color: 'amber', activo: true, enunciado: 'Dibujo libre: contactos, alianzas, ideas disruptivas u obviedades que no caben en los otros pilares.', subfrentes: [] }
      ],
