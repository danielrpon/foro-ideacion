...
window.STAGES = [
  ...
  { key: 'instrucciones_consolidacion',n: '1.5', label: 'Instr. Consolidación',          grupo: 'Consolidación' },
  ...
  { key: 'instrucciones_votacion',     n: '3.5', label: 'Instr. Votación',               grupo: 'Votación (opcional)' },
  { key: 'votacion',                   n: '4',   label: 'Votación',                      grupo: 'Votación (opcional)' },
  { key: 'resultados',                 n: '5',   label: 'Resultados de votación',        grupo: 'Votación (opcional)' },
  { key: 'instrucciones_matriz',       n: '5.5', label: 'Instr. Matriz',                 grupo: 'Priorización' },
  { key: 'matriz',                     n: '6',   label: 'Matriz Esfuerzo · Impacto',     grupo: 'Priorización', timer: 'minutos_matriz' },
...
window.MECE = {
  ...
  buildPrompt({ sesion, pilares, ideas }) {
    ...
    lineas.push('- Agrupa las ideas similares en IDEAS CONSOLIDADAS que conserven la esencia de todas las originales: ninguna idea se pierde y ninguna queda en dos grupos.');
    lineas.push('- Cada idea original debe aparecer EXACTAMENTE UNA VEZ en el campo "ideas" de algún grupo de SU MISMO pilar.');
    lineas.push('- Simplifica: entre 3 y 7 grupos por pilar (puede ser menos si hay pocas ideas). Una idea muy distinta puede ser un grupo sola.');
    lineas.push('- "titulo": nombre accionable y corto (máx. 60 caracteres), que se entienda en el muro.');
    lineas.push('- "descripcion_corta": una frase de máximo 160 caracteres para proyectar.');
    lineas.push('- "detalle": 2 a 4 frases que integren todas las ideas del grupo (menciona los matices distintos, no los pierdas).');
    lineas.push('- Responde SOLO con JSON válido, sin texto adicional ni bloques de código, con esta forma exacta:');
    lineas.push('{"grupos":[{"pilar_id":1,"titulo":"...","descripcion_corta":"...","detalle":"...","ideas":[12,15]}]}');
    lineas.push('');
    pilares.forEach(p => {
